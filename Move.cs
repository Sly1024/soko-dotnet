...
public struct Move
{
    public static readonly string[] PushCodeForDirection = ["L", "R", "U", "D"];
    ...
    // converts (int, int, bool, bool) tuple to Move
    public static implicit operator Move((int boxPos, int dir, bool otherSideReachable, bool isSameBoxAsBefore) a) => 
        new Move { encoded = (ushort)((a.isSameBoxAsBefore ? 1 << 15 : 0) | (a.otherSideReachable ? 1 << 14 : 0) | (a.boxPos << 2) | a.dir) };
    ...
    public bool IsSameBoxAsBefore => encoded >> 15 == 1;                   // first (16.) bit
