...
class Program
{
    ...
    private static void PrintCurrentStats()
    {
        ...
        // solver.forwardVisitedStates._probe_count = 0;
        // solver.forwardVisitedStates._findKeyOrEmpty_count = 0;
        // solver.backwardVisitedStates._probe_count = 0;
        // solver.backwardVisitedStates._findKeyOrEmpty_count = 0;
    }
}
